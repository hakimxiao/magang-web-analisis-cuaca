...
export default function ShortCuacaInfo({ cuaca }: { cuaca: CuacaProps}) {
  ...
  const tempData = [
    { label: "Pagi", value: cuaca.data[0].cuaca[0][0].t },
    { label: "Siang", value: cuaca.data[0].cuaca[0][1].t },
    { label: "Sore", value: cuaca.data[0].cuaca[0][2].t },
    { label: "Malam", value: cuaca.data[0].cuaca[0][3].t },
  ];
          ...
          <div className="flex flex-row gap-0.5">
            ...
            <div className="w-full h-[280px] flex flex-col">
              ...
              <div className="relative flex flex-col items-center mx-auto h-[100px]">
                <h1 className="text-8xl font-extralight mt-6 mb-4">{cuaca.data[0].cuaca[0][0].t}<span className="absolute top-5 text-5xl">°</span></h1>
                <p className="font-light text-md text-slate-500">{cuaca.data[0].cuaca[0][0].weather_desc}</p>
